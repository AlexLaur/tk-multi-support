...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(
            0, QtGui.QFormLayout.LabelRole, self.lab_subject
        )
        ...
        self.item_thumbnail.setPixmap(
            QtGui.QPixmap(":/tk_multi_support/camera.png")
        )
        ...
        self.formLayout.setWidget(
            2, QtGui.QFormLayout.FieldRole, self.item_thumbnail
        )
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(
            QtGui.QApplication.translate(
                "Dialog", "Problem Reporting", None, -1
            )
        )
        self.lab_subject.setText(
            QtGui.QApplication.translate("Dialog", "Subject", None, -1)
        )
        self.lie_subject.setPlaceholderText(
            QtGui.QApplication.translate("Dialog", "Subject", None, -1)
        )
        self.lab_content.setText(
            QtGui.QApplication.translate("Dialog", "Message", None, -1)
        )
        self.txe_content.setPlaceholderText(
            QtGui.QApplication.translate(
                "Dialog", "What's going wrong ?", None, -1
            )
        )
        self.lab_thumbnail.setText(
            QtGui.QApplication.translate("Dialog", "Thumbnail", None, -1)
        )
        self.item_thumbnail.setToolTip(
            QtGui.QApplication.translate(
                "Dialog", "Click to take a screenshot.", None, -1
            )
        )
        self.item_thumbnail.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "item thumbnail", None, -1)
        )
        self.pub_send.setText(
            QtGui.QApplication.translate("Dialog", "Send", None, -1)
        )
